...
void readConfig( istringstream& iss,
    ...
    while ( !iss.eof() ) {
        ...
        else if ( token == "normalization-type" ) {
            iss >> norm_type;
            iss >> norm_param;
        }
    }
    ...
    while ( getline( file, line ) ) {
        ...
        if ( layer_type == "<projection-layer>" ) {
            ...
            cout << left 
                 ...
                 << " norm-type " << setw(8) << norm_type
                 << " norm-param " << setw(8) << norm_param << endl;
        }
            ...
            cout << left 
                 ...
                 << " momentum " << setw(8) << momentum
                 << " weight-decay " << setw(8) << weight_decay 
                 << " forgetting-factor " << setw(8) << alpha
                 << " norm-type " << setw(8) << norm_type
                 << " norm-param " << setw(8) << norm_param << endl;
        }
            ...
            readConfig( iss, n_in, n_out, n_vocab, n_project, n_order,
                        momentum, weight_decay, alpha, lnZ, norm_type, norm_param );
            m_layer.push_back( new NCELayer( n_in, n_out, lnZ, norm_type, norm_param ) );
            cout << left
                 << setw(18) << "<NCE-layer>" << " : "
                 << setw(10) << n_in << "-->  "
                 << setw(10) << n_out
...
void Network::BackPropagate( const MatrixBase& target, float lr, MatrixBase* gradient ) {
